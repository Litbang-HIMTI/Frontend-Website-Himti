...
const organizer: NextPage<IDashboardProps> = (props) => {
	return (
		<>
			<Head>
				<meta charSet="UTF-8" />
				...
				<title>Event Organizer Dashboard | Himti UIN Jakarta</title>
			</Head>
			<Wrapper {...props}>
				<IdAndCount {...props} parent="event" parentSearch="organizer" fetchLink="/event/organizer" title="Event Organizer" />
			</Wrapper>
		</>
	);
};
