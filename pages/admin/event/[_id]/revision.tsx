...
import { EventRevision } from "../../../../src/components/Admin/Event";
	...
	return (
		<>
			<Head>
				...
				<title>View Event Revision | Himti UIN Jakarta</title>
			</Head>
...
export const getServerSideProps: GetServerSideProps = async (context) => {
	...
	const fetchBlogRevision = await fetch(`${SERVER_V1}/event/${context.params!._id}/revision`, {
		method: "GET",
		headers: {
			"Content-Type": "application/json",
			Cookie: "connect.sid=" + context.req.cookies["connect.sid"],
	...
	const eventRevision = await fetchBlogRevision.json();
	...
	return {
		props: {
			...
			eventRevision: eventRevision.data,
		},
	};
};
